...
{    
    ...
    public function view(string $view, string $render, $method = null){                
        ...
        if($this->valid == false and $this->block_url == false){
            ...
            if($this->view == $get_url){
                // include file
                if(file_exists($this->render) and str_contains($this->render, '.php')){
                    include_once $this->render;  
                    ob_end_flush();
                    return $this->valid = true;                              
                }else{
                    // include class
                    $file_class = "./Controllers/$this->render.php";                   
